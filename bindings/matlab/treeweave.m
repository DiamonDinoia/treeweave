    ...
    methods
        ...
        %   y = eval(obj, X, 'transposed', true)  y: out_dim×N (out_dim>1)
            ...
            if do_sorted
                ...
                % bz_eval_sorted returns Yflat as out_dim×N.
                Yflat = bz_eval_sorted(obj, X, od, N);
                y = Yflat';                       % N×out_dim
                return;
            end
            ...
            if do_transposed
                ...
                % bz_eval_soa (the treeweave_transposed C path) returns N×out_dim
                % with column d = component d; transpose for the SoA layout.
                Ysoa = bz_eval_soa(obj, Xflat(:), od, N);
                y = Ysoa';                         % out_dim×N
                return;
            end
            ...
            if N == 1
                ...
                Yflat = bz_eval_multi(obj, Xflat(:), od, N);
                y = Yflat';                        % N×out_dim
            end
        end
