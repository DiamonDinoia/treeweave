...
if(_treeweave_multiarch_family)
    ...
    # fan-out names carry the rung in their mangled name, and the variant TU's
    ...
    # group, and the local reference then points into a discarded section. GNU
    # ld rejects that ("defined in discarded section"); mold accepts it, so the
    # breakage only shows up on some linkers.
    foreach(_lvl IN LISTS _treeweave_arch_levels)
